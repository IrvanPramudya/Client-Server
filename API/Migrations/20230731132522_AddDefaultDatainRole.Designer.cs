            ...
            modelBuilder.Entity("API.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 7, 31, 20, 25, 22, 2, DateTimeKind.Local).AddTicks(6715),
                            ModifiedDate = new DateTime(2023, 7, 31, 20, 25, 22, 2, DateTimeKind.Local).AddTicks(6729),
                            Name = "Employee"
                        },
                        new
                        {
                            Guid = new Guid("4ec90656-e89c-4871-d9e5-08db8a7d0f37"),
                            CreatedDate = new DateTime(2023, 7, 31, 20, 25, 22, 2, DateTimeKind.Local).AddTicks(6735),
                            ModifiedDate = new DateTime(2023, 7, 31, 20, 25, 22, 2, DateTimeKind.Local).AddTicks(6736),
                            Name = "Manager"
                        },
                        new
                        {
                            Guid = new Guid("c0689b0a-5c87-46f1-ce19-08db91a71ab9"),
                            CreatedDate = new DateTime(2023, 7, 31, 20, 25, 22, 2, DateTimeKind.Local).AddTicks(6791),
                            ModifiedDate = new DateTime(2023, 7, 31, 20, 25, 22, 2, DateTimeKind.Local).AddTicks(6792),
                            Name = "Admin"
                        });
                });
